        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between bg-card/60 border border-border rounded-xl p-4">
            ...
            <button
              ...
              role="switch" aria-checked={audio.autoPlay} aria-label="Auto-play responses"
          ...
          <div className="bg-card/60 border border-border rounded-xl p-4">
            <div className="flex justify-between text-sm font-medium mb-2">
              <label htmlFor="speed-range">Speaking speed</label>
              <span className="text-muted-foreground">{audio.speed.toFixed(2)}×</span>
            </div>
            <input
              id="speed-range" aria-valuetext={`${audio.speed.toFixed(2)} times`}
